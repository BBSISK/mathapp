...
def get_student_mastery():
    ...
    topics = [
        'arithmetic', 'fractions', 'decimals', 'multiplication_division',
        'number_systems', 'bodmas', 'functions', 'probability', 'sets', 
...
def get_class_performance_matrix(class_id):
    ...
    topics = ['arithmetic', 'fractions', 'decimals', 'multiplication_division', 'number_systems', 'bodmas', 'probability', 'functions', 'sets', 'surds', 'complex_numbers_intro', 'complex_numbers_expanded']
    difficulties = ['beginner', 'intermediate', 'advanced']
